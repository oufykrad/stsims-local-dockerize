                ...
                if($count == 0){
                    ...
                    if($profile){            
                        ...
                        if($q){
                            ...
                            $address = $this->searchAddress($scholar['province'],$scholar['municipality'],$scholar['barangay'],$profile->id);
                            // if($address == null){
                            //     $address = $this->searchAddress($scholar['province'],$scholar['municipality'],$scholar['barangay'],$profile->id,0);
                            // }
